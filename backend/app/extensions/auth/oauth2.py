...
class OAuth2RequestValidator(provider.OAuth2RequestValidator):
    ...
    def __init__(self):
        from app.guard.auth.models import OAuth2Client, OAuth2Grant, OAuth2Token
    ...
    def _usergetter(self, username, password, client, request):
        ...
        from app.guard.users.models import User
    ...
    def _tokensetter(self, token, request, *args, **kwargs):
        ...
        expires_in = token['expires_in'] * 100
        expires = datetime.utcnow() + timedelta(seconds=expires_in*1000)
